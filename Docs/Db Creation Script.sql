...
, CONSTRAINT FK_Employee_Role FOREIGN KEY (id_Role) REFERENCES dbo.Role (id_Role)
)
GO
...
, CONSTRAINT FK_Dependent_Employee FOREIGN KEY (id_Employee) REFERENCES dbo.Employee (id_Employee)
)
...
, CONSTRAINT FK_Employee_Dependent_Employee FOREIGN KEY (id_Employee) REFERENCES dbo.Employee (id_Employee)
, CONSTRAINT FK_Employee_Dependent_Dependent FOREIGN KEY (id_Dependent) REFERENCES dbo.Dependent (id_Dependent)
)
